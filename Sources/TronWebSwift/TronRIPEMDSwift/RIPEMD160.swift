                ...
                if buffer.count > 0 && buffer.count + length >= 64 {
                    ...
                    try buffer.withUnsafeBytes { (body: UnsafeRawBufferPointer) in
                        if let bodyAddress = body.baseAddress, body.count > 0 {
                            ...
                            throw RIPEMD160Error.dataError
                        }
                    }
                    compress(X)
                    ptr += amount
...
extension RIPEMD160 {
    ...
    public static func hash(message: String) throws -> Data {
...
extension RIPEMD160 {
    ...
    public static func hmac(key: Data, message: Data) throws -> Data {
    ...
    public static func hmac(key: Data, message: String) throws -> Data {
        return try RIPEMD160.hmac(key: key, message: message.data(using: .utf8)!)
    }
    
    public static func hmac(key: String, message: String) throws -> Data {
