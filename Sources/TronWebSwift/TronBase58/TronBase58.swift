...
extension Array where Element == UInt8 {
    public var base58EncodedString: String {
        ...
        return TronBase58.base58FromBytes(self)
    }
    ...
    public var base58CheckEncodedString: String {
        ...
        return TronBase58.base58FromBytes(bytes)
    }
...
extension String {
    public var base58DecodedData: Data {
        let bytes = TronBase58.bytesFromBase58(self)
        return Data(bytes)
    }
    ...
    public var base58CheckDecodedBytes: [UInt8]? {
        var bytes = TronBase58.bytesFromBase58(self)
